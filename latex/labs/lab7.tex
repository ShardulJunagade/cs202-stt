...
I also wrote code to generate an overall \texttt{metrics\_summary.md} and, if Matplotlib was available, a bar chart \texttt{cyclomatic\_complexity.png} at \texttt{lab7/output/}.
...
\begin{itemize}[itemsep=0em, topsep=0pt]
    ...
    \item PyGraphviz (optional): \url{https://pygraphviz.github.io/}
\end{itemize}
