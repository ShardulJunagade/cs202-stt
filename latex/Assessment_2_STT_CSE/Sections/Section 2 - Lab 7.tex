% filepath: /Users/na/STT CSE Assignment 6/Sections/Section 1 - Lab 6.tex
\section{Lab Assignment 7: Reaching Definitions Analyzer for C Programs}
...
\subsection{Introduction, Setup, and Tools}
...
\insertimage[0.7\textwidth]{./lab7/1.png}[Environment Details]
...
\insertimage[0.7\textwidth]{./lab7/2.png}[\texttt{lab7/programs} folder snapshot]

\subsection{Approach and Implementation}

\subsubsection{Parsing and Cleaning -- \href{https://github.com/ShardulJunagade/cs202-stt/tree/main/lab7/analyzer/c_parser.py}{\texttt{analyzer/c\_parser.py}}}
\begin{itemize}[itemsep=0em, topsep=0pt]
    ...
    \insertimage[0.7\textwidth]{./lab7/3 new.png}[Code snippet -- \texttt{strip\_preprocessor\_and\_comments}]
    \item Extracted only the body of \texttt{main()} and tracked its starting line so later line numbers stayed meaningful.
    \insertimage[0.7\textwidth]{./lab7/4 new.png}[Code snippet -- \texttt{extract\_main\_function\_source}]
    \item I kept it deliberately simple; this worked fine for my inputs but wasn’t a full C parser.
\end{itemize}

\subsubsection{Basic Blocks and CFG Construction -- \href{https://github.com/ShardulJunagade/cs202-stt/tree/main/lab7/analyzer/cfg_builder.py}{\texttt{analyzer/cfg\_builder.py}}}
...
\begin{itemize}[itemsep=0em, topsep=0pt]
    ...
    \insertimage[0.8\textwidth]{./lab7/5.png}[Code snippet -- \texttt{\_find\_leaders}]
    ...
    \insertimage[0.8\textwidth]{./lab7/6.png}[Code snippet -- \texttt{\_build\_edges\_from\_blocks}]
\end{itemize}
...
\insertimage[0.7\textwidth]{./lab7/6_dot.png}[Code snippet -- DOT export and PNG rendering]

% \insertimage[0.7\textwidth]{./lab7/cfg.png}[Sample CFG (Preview)]
\noindent
\includegraphics[width=0.33\textwidth]{./lab7/cfg1.png}%
\includegraphics[width=0.33\textwidth]{./lab7/cfg2.png}%
\includegraphics[width=0.33\textwidth]{./lab7/cfg3.png}
...
\subsubsection{Definition Extraction -- \href{https://github.com/ShardulJunagade/cs202-stt/tree/main/lab7/analyzer/cfg_builder.py}{\texttt{analyzer/cfg\_builder.py}}}
...
\insertimage[0.7\textwidth]{./lab7/7.png}[Code snippet -- \texttt{\_extract\_defined\_variables\_from\_text}]

\insertimage[0.7\textwidth]{./lab7/8.png}[\texttt{definitions.md} preview]

\subsubsection{gen/kill Sets per Block -- \href{https://github.com/ShardulJunagade/cs202-stt/tree/main/lab7/analyzer/cfg_builder.py}{\texttt{analyzer/cfg\_builder.py}}}
...
\insertimage[0.65\textwidth]{./lab7/9.png}[Code snippet -- \texttt{\_compute\_gen\_kill\_sets}]


\subsubsection{Reaching Definitions (Data-Flow) -- \href{https://github.com/ShardulJunagade/cs202-stt/tree/main/lab7/analyzer/dataflow.py}{\texttt{analyzer/dataflow.py}}}
...
\insertimage[0.6\textwidth]{./lab7/10.png}[Code snippet -- \texttt{compute\_reaching\_definitions}]

\insertimage[0.65\textwidth]{./lab7/11.png}[\texttt{reaching\_definitions\_iterations.md} preview for iteration 0]

\subsubsection{Ambiguity Detection -- \href{https://github.com/ShardulJunagade/cs202-stt/tree/main/lab7/analyzer/dataflow.py}{\texttt{analyzer/dataflow.py}}}
...
\insertimage[0.8\textwidth]{./lab7/12.png}[Code snippet -- \texttt{find\_ambiguous\_variables}]

\insertimage[0.8\textwidth]{./lab7/13.png}[\texttt{ambiguity.md} preview]

\subsubsection{Runner and Outputs}
...
\insertimage[0.8\textwidth]{./lab7/14.png}[Code snippet -- Runner invoking analysis and writing outputs]

\insertimage[0.8\textwidth]{./lab7/15.png}[Terminal Output]
...
\insertimage[0.8\textwidth]{./lab7/16.png}[Code snippet -- Metrics summary generation]

\insertimage[0.8\textwidth]{./lab7/17.png}[\texttt{metrics\_summary.md} preview]

\insertimage[0.8\textwidth]{./lab7/18_cyclomatic_complexity.png}[Cyclomatic Complexity Chart]

\subsection{Results}

I am attaching links to key outputs for each program below because they are too large to embed here.

\subsubsection{CFG and Metrics}
...
\subsubsection{Reaching Definitions Tables}
...
\noindent Links to final iteration tables for each program:
\begin{itemize}[itemsep=0em, topsep=0pt]
...
\subsubsection{Ambiguity Highlights}
...
\noindent Links to detailed ambiguity tables for each program:
\begin{itemize}[itemsep=0em, topsep=0pt]
